  ...
  return (
    <div className="min-h-screen bg-light-bg dark:bg-dark-bg text-light-text dark:text-dark-text transition-colors duration-300">
      ...
      <div className="pt-16">
        ...
        <section id="home" className="relative w-full h-screen overflow-hidden">
          ...
          <div className="relative w-full h-full group">
            ...
            <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-4 text-white">
              ...
              <span className="inline-flex items-center gap-2 px-4 py-2 mb-8 text-sm font-semibold bg-white/10 backdrop-blur-md rounded-full border border-white/20 animate-fade-in">
        ...
        <section id="services" className="px-6 py-24 bg-slate-50 dark:bg-slate-900/50">
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-10">
              {[
                ...
                <div
                  key={i}
                  className="group bg-white dark:bg-slate-800 p-10 rounded-[2.5rem] border border-slate-200 dark:border-slate-700 hover:border-green-500/50 transition-all duration-300 hover:shadow-2xl shadow-sm"
                >
        ...
        <section id="about" className="py-24 px-6 bg-white dark:bg-dark-bg">
              ...
              {[
                ...
                <div key={i} className="relative group text-center">
                  <div className="flex flex-col items-center">
                    <div className="w-16 h-16 rounded-2xl bg-green-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 flex items-center justify-center text-green-600 mb-6 group-hover:bg-green-600 group-hover:text-white transition-all">
                      {item.icon}
                    </div>
                    <p className="font-bold text-lg">{item.name}</p>
                    <span className="text-sm font-bold text-green-600/40 mt-1 uppercase tracking-widest">
                      Phase {item.step}
                    </span>
                  </div>
                </div>
        ...
        {/* ================= CONTACT (ID: contact) ================= */}
        <section id="contact" className="py-24 px-6 bg-green-600 dark:bg-green-700">
          <div className="max-w-4xl mx-auto bg-white dark:bg-slate-900 p-8 md:p-12 rounded-[2.5rem] shadow-2xl">
            <div className="text-center mb-10">
              <h2 className="text-3xl font-bold mb-2 text-slate-900 dark:text-white">Connect with Our Experts</h2>
              <p className="text-slate-500 dark:text-slate-400">Schedule a demo or ask how we can support your specific crop needs.</p>
            </div>
            ...
            <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <input
                ...
                className="w-full p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-green-500 outline-none transition dark:text-white"
              />
              <input
                type="email"
              ...
              <textarea
                ...
                rows={4}
                className="w-full md:col-span-2 p-4 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 focus:ring-2 focus:ring-green-500 outline-none transition dark:text-white"
              />
              <button 
                type="button" 
                className="md:col-span-2 bg-green-600 text-white py-4 rounded-xl font-bold text-lg hover:bg-green-700 transition-all shadow-lg active:scale-95"
              >
                Submit Inquiry
              </button>
            </form>
